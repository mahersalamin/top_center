	...
	public function __construct()
	{
		...
		$this->defaults = [
			...
			*/
			...
			// Also whether kerning should be used in any direct writing e.g. $mpdf-custom->Text(),
			'useKerning' => false,
			...
			// LISTS
			// mPDF 6
			// 'mpdf-custom' or 'browser' - Specify whether to use mPDF custom method of automatic
