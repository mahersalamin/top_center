...
$db = new MyDB();
$outcomeData = $db->getOutcomeGraph($year); // Update this method to filter by year
...
$graph->title->Set('Yearly Outcome Spline Graph for ' . $year);
$graph->xaxis->title->Set('Month');
$graph->yaxis->title->Set('Amount');
$graph->SetTheme(new UniversalTheme);
...
$splinePlot->SetLegend('Monthly Outcome');
