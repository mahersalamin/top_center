...
INSERT INTO `att` (`id`, `st_id`, `tec_id`, `date`, `enter`, `exit`, `total`, `spc`, `aprove`, `processed`, `session_id`) VALUES
	...
	(132, '1', '4', NULL, '10:21:41', '10:23:47', '00:02:06', '2', 0, 1, 7),
	...
	(155, '48,12', '4', '2024-07-02', '11:33:08', '11:33:26', '00:00:18', '4', 1, 0, 28),
	(156, '48,12', '4', '2024-07-02', '11:33:29', '11:34:02', '00:00:33', '1', 0, 1, 28),
	(157, '48,12', '4', '2024-07-02', '14:06:44', '14:10:37', '00:03:53', '3', 1, 0, 28),
	(158, '4,7,56', '11', '2024-07-09', '11:58:50', '11:59:07', '00:00:17', '19', 1, 1, 35),
	(159, '53,3,54', '3', '2024-07-25', '09:00:13', '09:30:07', '00:29:54', '2', 0, 0, 61);
...
INSERT INTO `income` (`id`, `date`, `cashier`, `payer`, `amount`, `student_id`, `session_id`, `material`, `notes`) VALUES
	...
	(26, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 50, 56, 35, '0', 'تكملة الدفعة السابقة'),
	(27, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 50, 56, 35, '0', 'تكملة الدفعة السابقة'),
	(28, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 50, 56, 35, '0', 'تكملة الدفعة السابقة'),
	(29, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 100, 2, 7, '0', 'الدفعة الأولى'),
	(30, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 100, 2, 7, '0', 'الدفعة 2'),
	(31, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 100, 2, 7, '0', 'الدفعة 3'),
	(32, '2024-07-20 00:00:00', 'السكرتيرة', 'تلراتن', 100, 2, 7, '0', 'الدفعة 4'),
	(33, '2024-07-20 00:00:00', 'السكرتيرة', 'علي', 100, 2, 7, '0', 'دفعة 5'),
	(34, '2024-07-20 00:00:00', 'السكرتيرة', 'علي', 100, 2, 7, '0', 'الدفعة 6'),
	(35, '2024-07-20 00:00:00', 'السكرتيرة', 'علي', 100, 2, 7, '0', 'الدفعة 7'),
	(36, '2024-07-20 00:00:00', 'السكرتيرة', 'علي', 100, 2, 7, '0', 'الدفعة 8'),
	(37, '2024-07-20 00:00:00', 'الإدارة', 'ابو علي', 200, 2, 7, '0', 'الدفعة 9'),
...
INSERT INTO `sessions` (`id`, `session_name`, `type`, `material`, `hours`, `meetings`, `price`, `is_group`, `status`) VALUES
	...
	(6, 'mutaz - دورة خاصة', 'دورة خاصة', '3', '0', '0', 400.00, 0, 1),
	(7, 'دورة خاصة سبيشال', 'دورة خاصة', '12', '0', '0', 1200.00, 1, 1),
	(8, 'طلاب صف 5 ذكور السموع الاساسية', 'حقيبة مدرسية', '1,2,3,4,5', '20', '0', 600.00, 1, 1),
	(9, 'تست السعر لطالب', 'اشتراك شهري', '1,2,3,4,5', '10', '0', 1400.00, 0, 1),
	(10, 'اللغة الانجليزية ثانوي دورة خاصة', 'دورة خاصة', '10', '10', '0', 1500.00, 1, 1),
	(13, 'اول ثانوي دورة خاصة', 'دورة خاصة', '11', '0', '0', 400.00, 1, 1),
	(14, 'اشتراك شهري صف رابع', 'اشتراك شهري', '1,2,3,4,5', '12', '0', 900.00, 1, 1),
	(15, 'اشتراك شهري - توجيهي -', 'اشتراك شهري', '1,2,3,4,5,6', '20', '0', 1800.00, 1, 1),
	(16, 'اختبار نموذج متعدد الخطوات', 'دورة خاصة', '11,12', '0', '0', 1200.00, 1, 1),
	(17, 'اول ثانوي علمي', 'اشتراك شهري', '9,10,11,12', '0', '0', 1000.00, 1, 1),
	(18, 'دورة خاصة جماعية تست 2', 'دورة خاصة', '10', '2', '0', 50.00, 1, 1),
	(19, 'دورة خاصة لفحص الاسعار 4', 'دورة خاصة', '3', '2', '0', 40.00, 1, 1),
	(20, 'تست تسجيل سعر كامل وسعر منفصل للطلاب', 'دورة خاصة', '12', '3', '0', 300.00, 1, 1),
	(21, 'فحص تقسيم السعر للمعلمين', 'دورة خاصة', '11', '0', '0', 600.00, 1, 1),
	(24, 'teachers price2', 'دورة خاصة', '10', '3', '0', 800.00, 1, 1),
	(25, 'تست نسبة المعلم لكل سشن', 'دورة خاصة', '12', '0', '0', 300.00, 0, 1),
	(26, 'تست سعر سشن رقم 2', 'اشتراك شهري', '11,12', '12', '0', 600.00, 1, 1),
	(27, 'تست ثالث', 'حقيبة مدرسية', '1,2,3,4', '0', '0', 3000.00, 1, 1),
	(28, 'دورة عبري ابتدائي صف خامس', 'حقيبة مدرسية', '1,2,3,4', '20', '0', 1200.00, 1, 1),
	(29, 'فرنسي اول ثانوي', 'دورة خاصة', '17', '10', '0', 1200.00, 1, 1),
	(30, 'استاذين لنفس الدورة', 'دورة خاصة', '9,10', '6', '0', 300.00, 1, 1),
	(31, 'فحوصات', 'اشتراك شهري', '9,10,11', '20', '0', 1800.00, 1, 1),
	(32, 'فحوصات', 'اشتراك شهري', '9,10,11', '20', '0', 1800.00, 1, 1),
	(33, 'فحوصات', 'اشتراك شهري', '9,10,11', '20', '0', 1800.00, 1, 1),
...
INSERT INTO `session_students` (`session_id`, `student_id`, `session_cost`, `total_payments`, `payment_status`, `hours`) VALUES
	...
	(13, 2, 400.00, 400.00, 'مدفوع بالكامل', 0.00),
	...
	(28, 12, 600.00, 0.00, 'not paid', 20.00),
	(28, 48, 600.00, 0.00, 'not paid', 19.99),
	...
	(35, 4, 250.00, 0.00, 'not paid', 12.00),
	(35, 6, 250.00, 0.00, 'not paid', 0.00),
	(35, 7, 250.00, 0.00, 'not paid', 12.00),
	(35, 56, 250.00, 350.00, 'paid', 12.00),
...
DELETE FROM `spc`;
INSERT INTO `spc` (`id`, `name`, `class_type`) VALUES
...
-- Dumping data for table top_data.teacher_specializations: ~9 rows (approximately)
DELETE FROM `teacher_specializations`;
INSERT INTO `teacher_specializations` (`id`, `teacher_id`, `spec`) VALUES
	(1, 3, 2),
	(2, 3, 1),
	(7, 4, 11),
	(8, 4, 12),
