                ...
                <div class=" gap-5 ">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <img style="width: 30px; height: 30px; object-fit: cover; border-radius: 20%;" src="../sysdata/super.jpg" alt="">
                        ...
                        <li class="list-group-item">
                            ...
                            <label for="phone" style="color: black; display: inline; font-weight: bold">رقم الهاتف :</label>
                    ...
                    <a class="btn btn-secondary" href="<?php echo $_COOKIE['role'] == 2 ? "bodyHomeUser.php" : ($_COOKIE['role'] == 1 ? "homeAdmin.php" : ""); ?>">
                        رجوع  &gt;
                    </a>
                </div>
            </div>
