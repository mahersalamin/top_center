    ...
    <div class="container-fluid text-center ">
        <div class="row  mt-5 justify-content-center ">
            <div class="col-md-3 shadow p-3  bg-body rounded m-5">
                ...
                <img style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" src="../upload/super.jpg" alt="">
                ...
                <form action="../checkSingin.php" method="POST">
                    ...
                    <div class="form-group mb-4">
                        <input required type="password" name="password" class="form-control" aria-describedby="emailHelp" placeholder="كلمة المرور">
                    </div>
